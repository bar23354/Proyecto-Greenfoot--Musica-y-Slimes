...
/*
 * Codigo generado por ChatGPT. "Genera una clase Java llamada 'Josue' que extienda 'Actor' en el contexto de un juego en Greenfoot. 
 * Crea métodos para manejar el movimiento del personaje, la animación de caminar y atacar, el sistema de salud y el sistema de ataque. 
 * Asegúrate de que el personaje pueda moverse en cuatro direcciones (arriba, abajo, izquierda, derecha) 
 * y realizar un ataque en una dirección específica cuando se presione una tecla. 
 * Además, implementa la detección de colisiones con enemigos y la eliminación de enemigos cuando el personaje ataca"
 */
...
public class Josue extends Actor {
    ...
    private void handleHitbox() {
     ...
     public Josue(Counter killCounter) {
